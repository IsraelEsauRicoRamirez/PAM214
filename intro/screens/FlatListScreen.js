    ...
    return (
      <View style={styles.container}>
       ...
       <Text style={styles.item}>{item.nombre}</Text>   
        ...
        ListHeaderComponent={()=> (
          <Text style={styles.headerFooter}>Inicio de la lista estudiantes y materias</Text>
        ...
        ListFooterComponent={()=> (
          <Text style={styles.headerFooter}>Fin de la lista estudiantes y materias</Text>
